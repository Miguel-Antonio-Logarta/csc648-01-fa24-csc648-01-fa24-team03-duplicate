...
const Page = () => {
    ...
    return (
        <div className="p-8 bg-gray-100 min-h-[calc(100vh-5rem)]" style={{ background: 'linear-gradient(to right, #FCE0D3, #E89CA8)' }}>
            <div className="flex justify-center p-8">
                <div className="p-8 flex flex-col items-center justify-center bg-white w-100 h-32 shadow-lg rounded-lg">
